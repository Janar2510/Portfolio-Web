...
import type { PortfolioPage, PortfolioBlock } from '@/lib/services/portfolio';
...
interface EditorStore {
  ...
  sidebarTab: 'blocks' | 'styles' | 'pages' | 'settings';
  setSidebarTab: (tab: 'blocks' | 'styles' | 'pages' | 'settings') => void;
