  ...
  const services: Service[] = [
    {
      ...
      description:
        'Custom character designs, environmental concept art, and unique digital masterpieces tailored to your vision.',
      icon: <Palette className="text-indigo-400" size={32} />,
    },
    {
      title: 'UI/UX Visual Design',
      description:
        'Infusing creative artistic flair into digital products to create memorable and intuitive user experiences.',
      icon: <Monitor className="text-purple-400" size={32} />,
    },
    {
      title: 'Brand Art Direction',
      description:
        'Developing cohesive visual languages for brands that want to stand out with an artistic edge.',
      icon: <Layers className="text-pink-400" size={32} />,
    },
    {
      title: 'NFT Collections',
      description:
        'End-to-end creation and curation of unique digital asset collections for the modern collector.',
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20">
          ...
          <p className="max-w-md text-slate-400 mt-6 md:mt-0 leading-relaxed">
            Blending traditional techniques with cutting-edge technology to
            deliver visual excellence across multiple mediums.
          </p>
        </div>
