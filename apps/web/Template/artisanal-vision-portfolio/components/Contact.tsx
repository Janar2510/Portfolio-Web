      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <div>
            ...
            <h3 className="text-5xl md:text-6xl font-serif font-bold text-white mb-8">
              Let's Create <br /> Something Epic
            </h3>
            <p className="text-slate-400 text-lg mb-12 leading-relaxed">
              Available for collaborations, commissions, and speaking
              engagements worldwide. Whether you have a specific project in mind
