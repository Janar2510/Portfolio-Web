...
export const TOUR_HIGHLIGHTS: TourHighlight[] = [
  ...
  },
  {
    ...
    description: {
      en: 'Organize your work with Kanban boards, tasks, and deadlines.',
      et: 'Korralda oma tööd Kanban tahvlite, ülesannete ja tähtaegadega.',
    },
    position: 'right',
  },
  {
    ...
    description: {
      en: 'Track contacts, deals, and your sales pipeline all in one place.',
      et: 'Jälgi kontakte, tehinguid ja oma müügitoru ühes kohas.',
    },
    position: 'right',
  },
  {
    ...
    description: {
      en: "See who's visiting your portfolio and which pages perform best.",
      et: 'Vaata, kes külastab sinu portfooliot ja millised lehed toimivad kõige paremini.',
    },
    position: 'right',
  },
];
