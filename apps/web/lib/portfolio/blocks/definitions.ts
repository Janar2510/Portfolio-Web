...
import { SplitHeroBlock } from '@/components/portfolio/blocks/SplitHeroBlock';
import { CyberHeroBlock } from '@/components/portfolio/blocks/CyberHeroBlock';
import { OrganicHeroBlock } from '@/components/portfolio/blocks/OrganicHeroBlock';
...
blockRegistry.register({
  metadata: {
    ...
    name: 'Hero',
    description:
      'A large banner with a headline, subheadline, and call-to-action.',
    icon: LayoutTemplate,
    category: 'layout',
...
blockRegistry.register({
  metadata: {
    ...
    defaultContent: {
      headline: 'The Each Peak',
      subheadline: 'A Bold Vision for Tomorrow',
  ...
  ViewComponent: SplitHeroBlock as any,
  EditComponent: SplitHeroBlock as any,
});
...
blockRegistry.register({
  metadata: {
    type: 'cyber-hero',
    name: 'Cyber Hero',
    description: 'Ultra-advanced WebGPU hero with holographic depth effects.',
    icon: Sparkles,
    category: 'layout',
    schema: Schemas.cyberHeroBlockContentSchema,
    defaultContent: {
      headline: 'Build Your Dreams',
      subheadline: 'Holographic interfaces for the next generation.',
    },
    defaultSettings: {
      layout: 'full',
    },
  },
  ViewComponent: CyberHeroBlock as any,
  EditComponent: CyberHeroBlock as any,
});
...
blockRegistry.register({
  metadata: {
    type: 'organic-hero',
    name: 'Organic Hero',
    description: 'Nature-inspired hero with fluid animated backgrounds.',
    icon: LayoutTemplate,
    category: 'layout',
    schema: Schemas.organicHeroBlockContentSchema,
    defaultContent: {
      headline: 'Organic Flow',
      subheadline: 'Nature in Harmony',
    },
    defaultSettings: {
      layout: 'centered',
      animation: true,
  ...
  ViewComponent: OrganicHeroBlock as any,
  EditComponent: OrganicHeroBlock as any,
});
...
blockRegistry.register({
  metadata: {
    ...
    defaultContent: {
      ...
      legal_links: [{ label: 'Privacy Policy', url: '/privacy' }],
    },
    defaultSettings: {
      layout: 'simple',
    },
