...
export function Sidebar({ locale, collapsed = false, onToggle }: SidebarProps) {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        {
          label: t('nav.portfolioAnalytics'),
          href: '/analytics/portfolio',
          icon: BarChart3,
        },
        {
          label: t('nav.crmAnalytics'),
          href: '/analytics/crm',
          icon: BarChart3,
        },
        {
      ...
      <div className="h-full flex flex-col">
        ...
        {!collapsed && (
          <div className="p-4 border-b border-border">
            <h3 className="text-xs font-semibold text-neutral-500 dark:text-dark-text-secondary uppercase tracking-wider mb-3">
              {t('nav.quickActions')}
            </h3>
            <div className="space-y-2">
              <Link
                href="/crm/contacts"
                className="flex items-center gap-2 px-3 py-2 text-sm rounded-md bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-900/30 transition-colors"
              >
