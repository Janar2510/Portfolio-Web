...
const Scene = ({ imageUrl, depthUrl }: { imageUrl: string; depthUrl: string }) => {
...
export function CyberHeroBlock({
    ...
    const subtitle = content.subheadline || 'AI-powered creativity for the next generation.';
        ...
        `}</style>
                ...
                <div className="absolute bottom-[60px] left-0 right-0 flex justify-center z-[70]">
                    ...
                    >
                        ...
                        <span className="explore-arrow ml-1">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="arrow-svg">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    >
                        ...
                        <Scene
                            imageUrl={content.image_url || 'https://i.postimg.cc/XYwvXN8D/img-4.png'}
                            depthUrl={content.depth_url || 'https://i.postimg.cc/2SHKQh2q/raw-4.webp'}
                        />
                    </Canvas>
                </div>
            </div>
