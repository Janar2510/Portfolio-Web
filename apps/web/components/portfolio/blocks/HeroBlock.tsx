...
export function HeroBlock({
  ...
  return (
    <BaseBlock
      ...
      onEdit={onEdit}
      className={cn("w-full overflow-hidden", alignmentClasses[currentAlignment])}
    >
      <section
        className={cn(
        ...
        style={{
          backgroundColor: content.headline?.includes('Petra') ? '#BC4E3F' : undefined,
          backgroundImage: (settings.background === 'image' && content.image_url)
        ...
        >
          {content.badge && (
            <span className={cn(
              ...
              (settings.headline_style === 'script' || content.headline?.includes('Petra')) ? "" : "px-4 py-1.5 font-bold uppercase border border-primary/30 bg-primary/10 text-primary rounded-full animate-pulse"
            )}>
              {content.badge}
            </span>
          )}
          ...
          {content.headline && (
            <h1
              className={cn(
                ...
                (settings.headline_style === 'script' || content.headline?.includes('Petra'))
          ...
          {content.subheadline && (
            <p
              className={cn(
                ...
                (settings.headline_style === 'script' || content.headline === 'Petra') ? 'text-white' : 'text-slate-300',
          ...
          <div className={cn(
            ...
            {content.cta_text && content.cta_link && (
              <Button asChild size="lg" className={cn(
                ...
                (settings.headline_style === 'script' || content.headline === 'Petra')
