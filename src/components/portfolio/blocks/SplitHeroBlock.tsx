  ...
  return (
    ...
    >
      <section className="relative flex w-full flex-col overflow-hidden min-h-[85vh] md:flex-row">
          ...
          <div>
            ...
            <div className="mb-16 flex items-center gap-3">
              {content.logo_image ? (
                ...
                <div className="h-10 w-10 bg-zinc-800 rounded-md flex items-center justify-center font-bold text-xs uppercase">
                  Logo
                </div>
              )}
              <div>
            ...
            <div className="max-w-xl animate-in fade-in slide-in-from-left-4 duration-700">
              ...
              <p className="mb-12 text-lg md:text-xl text-zinc-400 font-medium leading-relaxed max-w-lg">
                {content.subtitle ||
                  'Discover breathtaking landscapes and challenge yourself with our guided mountain expeditions. Join a community of adventurers.'}
              </p>
        ...
        <div className="relative w-full min-h-[400px] md:w-1/2 lg:w-2/5 overflow-hidden animate-in fade-in duration-1000">
          <div
