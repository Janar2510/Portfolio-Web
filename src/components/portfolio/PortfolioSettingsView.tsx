...
export function PortfolioSettingsView({
  ...
  const [seoTitle, setSeoTitle] = useState(''); // Removed top-level seo_title
  const [seoDescription, setSeoDescription] = useState(''); // Removed top-level seo_description
  ...
  const updateSiteMutation = useMutation({
    mutationFn: async (data: {
      ...
      return await portfolioService.updateSite(site.id, { slug: data.subdomain } as any);
    },
    onSuccess: () => {
          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSaveGeneral} className="space-y-4">
                {/* Site Name field removed as it's not in Step 4 schema */}
