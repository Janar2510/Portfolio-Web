  ...
  return (
    <section className="py-32 relative overflow-hidden bg-background">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-secondary/10 rounded-full blur-[150px] translate-y-1/2 -translate-x-1/2" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <GradientButton
            asChild
            size="lg"
            className="text-lg px-12 py-8 rounded-2xl shadow-[0_0_30px_rgba(0,229,188,0.2)]"
          >
            <Link href="/register">
              {t('button')} <ArrowRight className="ml-2 size-6" />
            </Link>
          </GradientButton>
