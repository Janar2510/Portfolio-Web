...
interface StylesStore {
  ...
  updateCustomCSS: (css: string | undefined) => void;
  updateAssets: (assets: Partial<PortfolioSiteStyles['assets']>) => void;
  ...
  updateAssets: assets =>
    set(state => {
      ...
      return {
        styles: {
          ...state.styles,
          assets: { ...state.styles.assets, ...assets },
        },
        hasUnsavedChanges: true,
      };
    }),
