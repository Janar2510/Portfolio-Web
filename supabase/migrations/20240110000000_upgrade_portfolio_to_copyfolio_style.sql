...
-- Update existing RLS policies to use new table name
-- Note: The existing policies for portfolio_styles will need to be dropped and recreated
-- But we'll keep them working by updating the table reference
